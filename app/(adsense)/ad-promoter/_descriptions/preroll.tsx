...
const PrerollContainer = () => {
  const features = [
    {
      point: "Plays before the viewer's chosen content",
    },
    {
      point: "Guaranteed full-attention view",
    },
    {
      point: "Highest-value video placement",
    },
    {
      point: "Works on any device that plays video",
    },
    {
      point: "Ideal for brand awareness campaigns",
    },
  ];
...
export default PrerollContainer;
