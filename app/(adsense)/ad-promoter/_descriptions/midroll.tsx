...
const MidrollContainer = () => {
  const features = [
    {
      point: "Plays inside the content (content → ad → content)",
    },
    {
      point: "Catches viewers already engaged and invested",
    },
    {
      point: "Higher completion rates than pre-content ads",
    },
    {
      point: "Natural break point, feels less intrusive",
    },
    {
      point: "Strong performer for longer-form video",
    },
  ];
...
export default MidrollContainer;
