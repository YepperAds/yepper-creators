...
function HotDealPaymentCallbackContent() {
  ...
  useEffect(() => {
    const verify = async () => {
      ...
      try {
        ...
        const res = await fetch(`${BACKEND_URL}/api/hot-deals/verify-callback`, {
          method: 'POST',
          credentials: 'include',
          headers: {
